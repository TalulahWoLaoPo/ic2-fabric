...
object SolidCannerRecipeDatagen {
    ...
    private val entries = listOf(
        ...
        Entry("food_cake", EmptyTinCanItem::class.instance(), 12, Items.CAKE, 1,
              Registries.ITEM.get(Identifier("ic2_120", "filled_tin_can")), 12),
        // 西瓜片 2
        ...
        Entry("food_carrot", EmptyTinCanItem::class.instance(), 4, Items.CARROT, 1,
              Registries.ITEM.get(Identifier("ic2_120", "filled_tin_can")), 4),
        // 生猪排 3
        Entry("food_porkchop", EmptyTinCanItem::class.instance(), 3, Items.PORKCHOP, 1,
              Registries.ITEM.get(Identifier("ic2_120", "filled_tin_can")), 3),
        // 腐肉×2 -> 1
        ...
        Entry("food_pumpkin_pie", EmptyTinCanItem::class.instance(), 6, Items.PUMPKIN_PIE, 1,
              Registries.ITEM.get(Identifier("ic2_120", "filled_tin_can")), 6),
        // 马铃薯 1
        ...
        Entry("fuel_rod_uranium",
              ...
              Registries.ITEM.get(Identifier("ic2_120", "uranium")), 1,
              Registries.ITEM.get(Identifier("ic2_120", "uranium_fuel_rod")), 1),
        // 空燃料棒 + MOX -> MOX燃料棒
        Entry("fuel_rod_mox",
              Registries.ITEM.get(Identifier("ic2_120", "fuel_rod")), 1,
              Registries.ITEM.get(Identifier("ic2_120", "mox")), 1,
              Registries.ITEM.get(Identifier("ic2_120", "mox_fuel_rod")), 1)
    )
