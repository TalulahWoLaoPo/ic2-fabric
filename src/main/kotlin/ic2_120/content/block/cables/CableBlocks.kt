...
class GlassFibreCableBlock(settings: AbstractBlock.Settings = defaultSettings().nonOpaque()) : BaseCableBlock(settings), IInsulatedCable {

    override fun getTransferRate(): Long = 8192L
    override fun getEnergyLoss(): Long = 25L
    override fun getInsulationLevel(): Int = 5
}
...
class InsulatedCopperCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {

    override fun getTransferRate(): Long = 128L
    override fun getEnergyLoss(): Long = 200L
    override fun getInsulationLevel(): Int = 2
}
...
class InsulatedTinCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {
...
class InsulatedGoldCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {
...
class DoubleInsulatedGoldCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {

    override fun getTransferRate(): Long = 512L
    override fun getEnergyLoss(): Long = 400L
    override fun getInsulationLevel(): Int = 3
...
class InsulatedIronCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {
...
class DoubleInsulatedIronCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {
...
class TripleInsulatedIronCableBlock(settings: AbstractBlock.Settings = defaultSettings()) : BaseCableBlock(settings), IInsulatedCable {

    override fun getTransferRate(): Long = 2048L
    override fun getEnergyLoss(): Long = 800L
    override fun getInsulationLevel(): Int = 4
