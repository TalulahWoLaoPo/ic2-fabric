...
import ic2_120.content.blockentities.MaceratorBlockEntity
...
class MaceratorBlock(settings: AbstractBlock.Settings = AbstractBlock.Settings.create().strength(3.5f)) : MachineBlock(settings) {
    ...
    override fun <T : BlockEntity> getTicker(
        ...
        else checkType(type, ModBlockEntities.getType(MaceratorBlockEntity::class)) { w, p, s, be -> (be as MaceratorBlockEntity).tick(w, p, s) }
