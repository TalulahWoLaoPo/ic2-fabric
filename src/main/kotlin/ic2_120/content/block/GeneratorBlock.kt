...
import ic2_120.content.blockentities.GeneratorBlockEntity
...
class GeneratorBlock(settings: AbstractBlock.Settings = AbstractBlock.Settings.create().strength(3.5f)) : MachineBlock(settings) {
    ...
    override fun <T : BlockEntity> getTicker(
        ...
        else checkType(type, ModBlockEntities.getType(GeneratorBlockEntity::class)) { w, p, s, be -> (be as GeneratorBlockEntity).tick(w, p, s) }
