...
import ic2_120.content.blockentities.CompressorBlockEntity
...
class CompressorBlock(settings: AbstractBlock.Settings = AbstractBlock.Settings.create().strength(3.5f)) : MachineBlock(settings) {
    ...
    override fun <T : BlockEntity> getTicker(
        ...
        else checkType(type, ModBlockEntities.getType(CompressorBlockEntity::class)) { w, p, s, be -> (be as CompressorBlockEntity).tick(w, p, s) }
