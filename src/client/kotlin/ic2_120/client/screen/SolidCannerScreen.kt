...
class SolidCannerScreen(
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        val progressFrac = if (SolidCannerSync.PROGRESS_MAX > 0) {
            (progress.toFloat() / SolidCannerSync.PROGRESS_MAX).coerceIn(0f, 1f)
        } else 0f
        ...
        val content: UiScope.() -> Unit = {
            Row(
                ...
                Column(
                    ...
                    // 放电槽
                    SlotHost(SolidCannerScreenHandler.SLOT_DISCHARGING_INDEX)
                }
                ...
                Column(
                    ...
                    for (slotIndex in SolidCannerScreenHandler.SLOT_UPGRADE_INDEX_START..SolidCannerScreenHandler.SLOT_UPGRADE_INDEX_END) {
                        SlotHost(slotIndex)
                    }
                }
            }
    ...
    private fun UiScope.SlotHost(slotIndex: Int) {
        SlotAnchor(
            ...
            width = SolidCannerScreenHandler.SLOT_SIZE,
            height = SolidCannerScreenHandler.SLOT_SIZE
        )
    }
