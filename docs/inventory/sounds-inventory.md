...
| `machine.fabricator.loop` | `ic2:machines/fabricator/loop` | 复制机/质能机主循环音 | ❌ 未实现 |
| `machine.fabricator.scrap` | `ic2:machines/fabricator/scrap` | 复制机吞废料加速提示音 | ❌ 未实现 |
| `machine.furnace.electric.loop` | `ic2:machines/furnace/electric/loop` | 电炉运行循环音 | ✅ 已实现 |
| `machine.furnace.electric.start` | `ic2:machines/furnace/electric/start` | 电炉启动音 | ✅ 已实现 |
| `machine.furnace.electric.stop` | `ic2:machines/furnace/electric/stop` | 电炉停止音 | ✅ 已实现 |
| `machine.furnace.induction.loop` | `ic2:machines/furnace/induction/loop` | 感应炉运行循环音 | ✅ 已实现 |
| `machine.furnace.induction.start` | `ic2:machines/furnace/induction/start` | 感应炉启动音 | ✅ 已实现 |
| `machine.furnace.induction.stop` | `ic2:machines/furnace/induction/stop` | 感应炉停止音 | ✅ 已实现 |
